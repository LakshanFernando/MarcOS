...
void  drawHomeMenu()  {           //  main menu for all settings (Leds, Time, etc...) 6 buttons
  ...
  tft.println("Target 01"); //Menu Items 01
  ...
  tft.println("Target 02");//Menu Items 02
  ...
  tft.println("Target 03");//Menu Items 03
  ...
  tft.println("Target 04");//Menu Items 04
  ...
  tft.println("Target 01");//Menu Items 05
